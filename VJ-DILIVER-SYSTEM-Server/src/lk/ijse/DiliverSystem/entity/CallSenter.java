...
public class CallSenter {
    ...
    public CallSenter(String CallSenterID, String Name, String Address, int TeloponeNo, int age, String NIC, double Salary, String Time, String Date) {
    ...
    public String toString() {
        return "CallSenter{" + "CallSenterID=" + CallSenterID + ", Name=" + Name + ", Address=" + Address + ", TeloponeNo=" + TeloponeNo + ", age=" + age + ", NIC=" + NIC + ", Salary=" + Salary + ", Time=" + Time + ", Date=" + Date + '}';
    }
}
