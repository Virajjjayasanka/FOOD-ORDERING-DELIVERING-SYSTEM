...
public class RiderGetOrder {
    ...
    public RiderGetOrder(int SubmitOrderID, int Orderid, String TeleponeOperterName, String CustomerID, double Total, String RiderName, String Time) {
    ...
    public String toString() {
        return "RiderGetOrder{" + "SubmitOrderID=" + SubmitOrderID + ", Orderid=" + Orderid + ", TeleponeOperterName=" + TeleponeOperterName + ", CustomerID=" + CustomerID + ", Total=" + Total + ", RiderName=" + RiderName + ", Time=" + Time + '}';
    }
