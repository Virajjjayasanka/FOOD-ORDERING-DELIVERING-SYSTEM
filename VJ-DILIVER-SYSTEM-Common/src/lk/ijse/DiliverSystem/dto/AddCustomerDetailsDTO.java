 ...
 */
public class AddCustomerDetailsDTO  extends SuperDTO{
    ...
    public AddCustomerDetailsDTO() {
    }

    public AddCustomerDetailsDTO( String CustomeID, String OrderID, String CustomerName, String CustomerAddress, int CustomertelponeNO, int CustomerOtherNO, String Time, String Date) {
    ...
    public AddCustomerDetailsDTO(int SaveOrderID, String CustomeID, String OrderID, String CustomerName, String CustomerAddress, int CustomertelponeNO, int CustomerOtherNO, String Time, String Date) {
