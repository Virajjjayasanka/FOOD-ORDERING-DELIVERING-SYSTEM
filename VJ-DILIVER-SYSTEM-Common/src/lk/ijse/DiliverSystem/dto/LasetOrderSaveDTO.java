 ...
 */
public class LasetOrderSaveDTO extends SuperDTO{
    ...
    public LasetOrderSaveDTO() {
    }

    public LasetOrderSaveDTO( int SumbitOrderID, int OrderID, int CustomerID, String TeleponrOPerterName, String RiderName, String GetOrderTime, String OutOrderTime, String Payament, double Total, String date) {
    ...
    public LasetOrderSaveDTO(int SaveOrderId, int SumbitOrderID, int OrderID, int CustomerID, String TeleponrOPerterName, String RiderName, String GetOrderTime, String OutOrderTime, String Payament, double Total, String date) {
    ...
    public String toString() {
        return "LasetOrderSaveDTO{" + "SaveOrderId=" + SaveOrderId + ", SumbitOrderID=" + SumbitOrderID + ", OrderID=" + OrderID + ", CustomerID=" + CustomerID + ", TeleponrOPerterName=" + TeleponrOPerterName + ", RiderName=" + RiderName + ", GetOrderTime=" + GetOrderTime + ", OutOrderTime=" + OutOrderTime + ", Payament=" + Payament + ", Total=" + Total + ", date=" + date + '}';
    }
